        ...
        <main className="max-w-[1500px] mx-auto px-6 pb-6">
            ...
            <div className="p-5 grid grid-cols-1 md:grid-cols-4 gap-4 shadow-md border border-gray-300 rounded-xl">
                    ...
                    <div className="cols-span-1 md:col-span-3">
                        ...
                        <p className="mb-2"><strong>Check out date:</strong> 13.12.2024</p>
                        <p className="mb-2" ><strong>Number of nights:</strong> 2</p>
                        <p className="mb-2"><strong>Total price:</strong> 200$</p>

                        <div className="mt-6 inline-block cursor-pointer py-4 px-6 bg-PWRoom text-white rounded-xl text-center">
                            Go to Property
                        </div>    
